...
- Step 3 (Knowledge & Source of Truth) repo-native-first foundation with built-in Context7 for each planned file
...
- the full external-knowledge version of Step 3 beyond the current built-in Context7 slice
- `web_fetch` / URL permission-policy integration
- user-defined MCP merge and broader `KnowledgeSvc` rollout
