...
The app does **not** yet implement:
 ...
 - richer `web_fetch` / URL permission-policy integration beyond the current public-URL baseline plus redirect-aware host-policy and hostname DNS-classification foundations
- remote MCP support
