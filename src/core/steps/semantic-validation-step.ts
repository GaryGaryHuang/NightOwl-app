...
const SEMANTIC_VALIDATION_INSTRUCTION = [
  ...
  "- Set `loopControl.action = \"rerun\"` only when at least one candidate is `rewrite_required`.",
  ...
  "{\"perFindingResults\": [{\"findingId\": \"F1\", \"decision\": \"rewrite_required\", \"failedGates\": [\"impact\"], \"requiredCorrections\": [\"Prove the concrete user/system impact from existing candidate evidence, or drop the candidate if that proof is unavailable.\"], \"reason\": \"impact is asserted but not proven\"}], \"missingInformationItems\": [], \"loopControl\": {\"action\": \"rerun\", \"reason\": \"candidate payload must repair machine-actionable evidence gaps\"}}",
  "",
