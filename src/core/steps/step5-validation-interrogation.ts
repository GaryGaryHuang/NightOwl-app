...
const STEP5_INSTRUCTION = [
  ...
  "",
  "1. Validate each `hypothesisLedger` entry in sequence as testable review work; do not assume or force a candidate.",
  "",
  "2. For each scenario or rerun correction:",
  ...
  "",
  "6. Apply the speculation and missing-information filter:",
  ...
  "",
  "7. Before output, re-check each candidate:",
