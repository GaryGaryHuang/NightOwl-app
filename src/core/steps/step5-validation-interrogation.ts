...
const STEP5_SYSTEM_ADDITION = [
  ...
  "- Every finding must include `findingId`, `supportingEvidence`, `reachability`, and `uncertaintyStatus`. Only `\"supported\"` findings with credible reachability will be accepted.",
...
const STEP5_INSTRUCTION = [
  ...
  "",
  "6. Every finding must include an `uncertaintyStatus`:",
