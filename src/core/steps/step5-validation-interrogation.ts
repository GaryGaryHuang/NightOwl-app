...
const STEP5_INSTRUCTION = [
  ...
  "   - `reachability`: an object with boolean `credible`, non-empty string `entryPoint`, and non-empty `guardsChecked` array explaining the entry path and guards considered",
