...
const STEP6_SYSTEM_ADDITION = [
  ...
  "- Use `rewrite_required`, `downgrade`, `drop`, or `convert_to_missing_information` when evidence, trigger, impact, counter-evidence, classification/severity alignment, identifiers, anchors, or hypothesis closure are insufficient.",
...
const STEP6_INSTRUCTION = [
  ...
  "   - Evidence: the candidate's evidence must be concrete, traceable, and consistent with `ReviewBasisV1.evidenceRefs` and the reviewed code.",
  ...
  "   - Trigger condition: the trigger must be credible, concrete, and consistent with the diff.",
  "   - Impact: the user/system impact must be specific and proportionate to the proven evidence.",
  "   - Counter-evidence: the candidate must show meaningful counter-evidence was checked.",
  "   - Classification/severity alignment: classification and severity must match the proven evidence level.",
  ...
  "   - `downgrade`: evidence supports a lower classification or severity than Step 5 claimed.",
