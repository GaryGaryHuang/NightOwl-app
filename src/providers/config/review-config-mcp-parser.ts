...
function resolveContext7OverrideEntry(
  ...
  const tools = readOptionalField(
    rawDefinition,
    "tools",
    readStringArray,
    "'tools' must be an array of strings"
  );
  const timeout = readOptionalField(
    rawDefinition,
    "timeout",
    readPositiveInteger,
...
function resolveRemoteMcpEntry(
  ...
  const headers = readOptionalField(
    rawDefinition,
    "headers",
    readStringRecord,
    "'headers' must be a string record"
  );
  const tools = readOptionalField(
    rawDefinition,
    "tools",
...
function resolveLocalMcpEntry(
  ...
  const command = readRequiredField(
    rawDefinition,
    "command",
    readNonBlankString,
    "'command' must be a non-blank string"
  );
  const args = readOptionalField(
    rawDefinition,
    "args",
    readStringArray,
    "'args' must be an array of strings"
  );
  const env = readOptionalField(
    rawDefinition,
    "env",
    readStringRecord,
    "'env' must be a string record"
  );
  const tools = readOptionalField(
    rawDefinition,
    "tools",
