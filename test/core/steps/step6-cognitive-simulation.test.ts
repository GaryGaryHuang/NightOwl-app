...
test("Step6CognitiveSimulationStep prepares the exact Step 6 prompt contract from diff and current review", () => {
  ...
  assert.equal(plan.stepId, "step6-cognitive-simulation");
